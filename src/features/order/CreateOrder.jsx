      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.longitude && (
            <span className="absolute right-[3px] top-[2.5px] z-50 md:right-[5px] md:top-[5px]">
              <Button
                disabled={isLoadingAdress}
                type="small"
                onClick={(e) => {
        ...
        <div>
          ...
          <Button disbled={isSubmitting || isLoadingAdress} type="primary">
            {isSubmitting
              ? "Placing Order..."
...
export async function action({ request }) {
  ...
  store.dispatch(clearCart()); // SHOULD NOT BE OVERUSED
